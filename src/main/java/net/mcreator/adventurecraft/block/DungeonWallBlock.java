...
public class DungeonWallBlock extends AdventureCraftElements.ModElement {
	@ObjectHolder("adventurecraft:dungeonwall")
	public static final Block block = null;
	public DungeonWallBlock(AdventureCraftElements instance) {
		super(instance, 2);
	}
